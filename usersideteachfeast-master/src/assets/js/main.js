(function($) {
  ...
  sliderrange.slider({
    ...
    slide: function(event, ui) {
      amountprice.val('Rs.' + ui.values[0] + ' - ' + ui.values[1]);
      $('#amountTo').val(ui.values[0]);
      $('#amountFrom').val(ui.values[1]);
    }
  });
  amountprice.val('Rs.' + sliderrange.slider('values', 0) + ' - ' + sliderrange.slider('values', 1));
